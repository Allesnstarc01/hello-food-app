...
const SearchPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto my-10 ml-6 mr-6">
                  ...
                  >
                    ...
                    <CardFooter className="p-4 border-t dark:border-t-gray-700 border-t-gray-100 text-white flex justify-end">
                      <Link to={`/restaurant/${restaurant._id}`}>
                        <Button className="bg-orange hover:bg-hoverGreen font-semibold py-2 px-4 rounded-full shadow-md transition-colors duration-200">
                          View Menus
                        </Button>
                      </Link>
                    </CardFooter>
...
const NoResultFound = ({ searchText }: { searchText: string }) => {
  return (
    <div className="text-center">
      ...
      <Link to="/">
        <Button className="mt-4 bg-orange hover:bg-hoverGreen">
          Go Back to Home
        </Button>
      </Link>
    </div>
